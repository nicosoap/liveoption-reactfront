/**
 * Created by opichou on 10/29/16.
 */
...
export class Terms extends Component {
    render() {
        ...
        return (
            ...
            <div>
                <h2>Welcome to liveoption!</h2>
                <p>These terms and conditions outline the rules and regulations for the use of liveoption's Website.
                    <br />
                    <span>liveoption</span> is located at:<br />

                        10 rue Neuve Popincourt , <br />
                        Paris, IDF 75011<br />
                        France<br />

                    By accessing this website we assume you accept these terms and conditions in full. Do not continue
                    to use liveoption's website if you do not accept all of the terms and conditions stated on this
                    page.
                </p>
                <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer
                    ...
                    services/products, in accordance with and subject to, prevailing law of France. Any use of the above
                ...
                <h2>Cookies</h2>
                <p>We employ the use of cookies. By using <a href="http://www.liveoption.io">liveoption</a>'s website you consent to
                    the use of cookies in accordance with liveoption’s privacy policy.</p>
                ...
                <h2>License</h2>
                <p>Unless otherwise stated, liveoption and/or it’s licensors own the intellectual property rights for
                    all material on liveoption All intellectual property rights are reserved. You may view and/or print
                    pages from http://www.liveoption.io for your own personal use subject to restrictions set in these
                    terms and conditions.</p>
                <p>You must not:</p>
                <ul>
                    <li>Republish material from http://www.liveoption.io</li>
                    <li>Sell, rent or sub-license material from http://www.liveoption.io</li>
                    <li>Reproduce, duplicate or copy material from http://www.liveoption.io</li>
                </ul>
                <p>Redistribute content from liveoption (unless content is specifically made for redistribution).</p>

                <h3>User Comments</h3>
                <ol>
                    <li>This Agreement shall begin on the date hereof.</li>
                    <li>Certain parts of this website offer the opportunity for users to post and exchange opinions,
                        information, material and data ('Comments') in areas of the website. liveoption does not screen,
                        edit, publish or review Comments prior to their appearance on the website and Comments do not
                        reflect the views or opinions of liveoption, its agents or affiliates. Comments reflect the view
                        and opinion of the person who posts such view or opinion. To the extent permitted by applicable
                        laws liveoption shall not be responsible or liable for the Comments or for any loss cost,
                    ...
                    <li>liveoption reserves the right to monitor all Comments and to remove any Comments which it
                        considers in its absolute discretion to be inappropriate, offensive or otherwise in breach of
                    ...
                    <li>You hereby grant to <strong>liveoption</strong> a non-exclusive royalty-free license to use,
                ...
                <p>We will approve link requests from these organizations if we determine that: (a) the link would not
                    ...
                    liveoption; and (d) where the link is in the context of general resource information or is otherwise
                    consistent with editorial content in a newsletter or similar product furthering the mission of the
                    organization.</p>
                ...
                <p>If you are among the organizations listed in paragraph 2 above and are interested in linking to our
                    website, you must notify us by sending an e-mail to <a href="mailto:olivierpichouparis@gmail.com"
                                                                           title="send an email to olivierpichouparis@gmail.com">olivierpichouparis@gmail.com</a>.
                ...
                <p>No use of (cname)’s logo or other artwork will be allowed for linking absent a trademark license
                    agreement.</p>
